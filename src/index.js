// Решал принципиально без регулярок
const MORSE_TABLE = {
    '.-':     'a',
    '-...':   'b',
    '-.-.':   'c',
...
function decode(expr) {
    ...
    // Превращаю элементы массива(коды морзе) в зашифрованые буквы и возвращаю из этого массива результативную строку - зашифрованное предложение
